 ...
 *
 */
public class PadreNoticiasFragment extends Fragment {


    public PadreNoticiasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_padre_noticias, container, false);
