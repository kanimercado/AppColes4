 ...
 *
 */
public class ProfesorMiasFragment extends Fragment {


    public ProfesorMiasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_profesor_mias, container, false);
